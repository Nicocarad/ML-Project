...
def plot_RAW_results(min_dcf_05,min_dcf_01,min_dcf_09, name,title):
    ...
    plt.plot(lambda_values, min_dcf_05, label="minDCF(\u03C0_T = 0.5)")
    plt.plot(lambda_values, min_dcf_01, label="minDCF(\u03C0_T = 0.1)")
    plt.plot(lambda_values, min_dcf_09, label="minDCF(\u03C0_T = 0.9)")
