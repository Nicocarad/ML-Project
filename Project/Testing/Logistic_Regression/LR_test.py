...
def plot_RAW_results(min_dcf_05, min_dcf_01, min_dcf_09, min_dcf_05_eval, min_dcf_01_eval, min_dcf_09_eval, name, title):
    ...
    plt.plot(lambda_values, min_dcf_05_eval, label="minDCF(\u03C0 = 0.5 EVAL)", color="red", linestyle="dashed")
    plt.plot(lambda_values, min_dcf_01_eval, label="minDCF(\u03C0 = 0.1 EVAL)", color="blue", linestyle="dashed")
    plt.plot(lambda_values, min_dcf_09_eval, label="minDCF(\u03C0 = 0.9 EVAL)", color="green", linestyle="dashed")
...
def LR_RAW_val_eval(DTR, LTR, DTE, LTE, prior):
    ...
    regression = Logistic_Regression(0)  # Placeholder for regression model
    reg_eval = Logistic_Regression(0)  # Placeholder for evaluation model
