...
def bayes_error_plot_multi(
    llr_LR, Label_LR, llr_SVM, Label_SVM, llr_GMM, Label_GMM, name
):
    effPriorLogOdds = np.linspace(-4, 4, 100)
    ...
    plt.plot(
        effPriorLogOdds, mindcf_LR, label="min DCF LR", color="red", linestyle="dashed"
    )
